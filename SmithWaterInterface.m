...
matrix=createSubstitudeMatrixFromFile(p.Results.matrixFileName);
else
   disp("Nie podano pliku macierzy substytucji")
end
[scoreMatrix,a,b]=smithWaterman(seq1,seq2,matrix,p.Results.gap);
[road,matchMatrix, gaps, Length,score,new_seq1,new_seq2,identity,colB,rowB,rowF,colF]= TraceBack(scoreMatrix,seq1,seq2,matrix,p.Results.gap,a,b);
