...
gap = -2;
matrix=getSubstitudeMatrixFromFile('matrix.csv');
disp("Gap: " + gap);
%% smith waterman 
scoreMatrix=smithWaterman(seq1,seq2,matrix,gap);
[road,matchMatrix, gaps, Length,score,new_seq1,new_seq2,identity] = TraceBack(scoreMatrix,seq1,seq2,matrix,gap);
disp("score: " + score);
